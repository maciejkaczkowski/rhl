...
type
  ...
  TrhlTiger = class abstract(TrhlHash)
  protected
    m_hash: array[0..2] of QWord;
    FRounds: Integer;
    FPadding: Byte;
  ...
  TrhlTigerSO = class abstract(TrhlTiger) // swap order
  public
    procedure Final(var ADigest); override;
  end;
  ...
  TrhlTiger128r3so = class(TrhlTigerSO)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger128r4so = class(TrhlTigerSO)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger160r3so = class(TrhlTigerSO)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger160r4so = class(TrhlTigerSO)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger192r3so = class(TrhlTigerSO)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger192r4so = class(TrhlTigerSO)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger128r3 = class(TrhlTiger)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger128r4 = class(TrhlTiger)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger160r3 = class(TrhlTiger)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger160r4 = class(TrhlTiger)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger192r3 = class(TrhlTiger)
  public
    constructor Create; override;
  end;
  ...
  TrhlTiger192r4 = class(TrhlTiger)
  public
    constructor Create; override;
  end;
...
procedure TrhlTigerSO.Final(var ADigest);
begin
  inherited Final(ADigest);
  ConvertQWordsToBytesSwapOrder(m_hash[0], Length(m_hash), m_hash[0]);
  Move(m_hash[0], ADigest, HashSize);
end;

{ TrhlTiger128r3so }

constructor TrhlTiger128r3so.Create;
begin
  inherited Create;
  HashSize := 16;
  FRounds := 3;
...
constructor TrhlTiger128r4so.Create;
begin
  inherited Create;
  HashSize := 16;
  FRounds := 4;
...
constructor TrhlTiger160r4so.Create;
begin
  inherited Create;
  HashSize := 20;
  FRounds := 4;
...
constructor TrhlTiger160r3so.Create;
begin
  inherited Create;
  HashSize := 20;
  FRounds := 3;
...
constructor TrhlTiger192r4so.Create;
begin
  inherited Create;
  FRounds := 4;
end;
...
constructor TrhlTiger192r3so.Create;
begin
  inherited Create;
  FRounds := 3;
end;
...
constructor TrhlTiger128r3.Create;
begin
  inherited Create;
  HashSize := 16;
  FRounds := 3;
...
constructor TrhlTiger128r4.Create;
begin
  inherited Create;
  HashSize := 16;
  FRounds := 4;
...
constructor TrhlTiger160r4.Create;
begin
  inherited Create;
  HashSize := 20;
  FRounds := 4;
...
constructor TrhlTiger160r3.Create;
begin
  inherited Create;
  HashSize := 20;
  FRounds := 3;
...
constructor TrhlTiger192r4.Create;
begin
  inherited Create;
  FRounds := 4;
end;
...
constructor TrhlTiger192r3.Create;
begin
  inherited Create;
  FRounds := 3;
end;
...
procedure TrhlTiger.UpdateBlock(const AData);
const
  T1: array[0..255] of QWord = (
  ...
  C1: QWord = $A5A5A5A5A5A5A5A5;
  C2: QWord = $0123456789ABCDEF;
var
  rounds: Integer;
  a, b, c: QWord;
  temp_a: QWord;
...
begin
  Move(AData, data[0], SizeOf(data));
  a := m_hash[0];
  b := m_hash[1];
  c := m_hash[2];

  c := c xor data[0];
  a -= T1[byte(c)] xor T2[byte(c shr 16)] xor T3[byte(c shr 32)] xor T4[byte(c shr 48)];
  b += T4[byte(c shr 8) and $ff] xor T3[byte(c shr 24)] xor T2[byte(c shr 40)] xor T1[byte(c shr 56)];
  b *= 5;

  a := a xor data[1];
  b -= T1[byte(a)] xor T2[byte(a shr 16)] xor T3[byte(a shr 32)] xor T4[byte(a shr 48)];
  c += T4[byte(a shr 8)] xor T3[byte(a shr 24)] xor T2[byte(a shr 40)] xor T1[byte(a shr 56)];
  c *= 5;

  b := b xor data[2];
  c -= T1[byte(b)] xor T2[byte(b shr 16)] xor T3[byte(b shr 32)] xor T4[byte(b shr 48)];
  a += T4[byte(b shr 8)] xor T3[byte(b shr 24)] xor T2[byte(b shr 40)] xor T1[byte(b shr 56)];
  a *= 5;
  ...
  data[0] -= data[7] xor C1;
  data[1] := data[1] xor data[0];
  data[2] += data[1];
  data[3] -= data[2] xor (not data[1] shl 19);
  data[4] := data[4] xor data[3];
  data[5] += data[4];
  data[6] -= data[5] xor (not data[4] shr 23);
  data[7] := data[7] xor data[6];
  data[0] += data[7];
  data[1] -= data[0] xor (not data[7] shl 19);
  data[2] := data[2] xor data[1];
  data[3] += data[2];
  data[4] -= data[3] xor (not data[2] shr 23);
  data[5] := data[5] xor data[4];
  data[6] += data[5];
  data[7] -= data[6] xor C2;
  ...
  m_hash[0] := m_hash[0] xor a;
  m_hash[1] := b - m_hash[1];
  m_hash[2] += c;
end;

constructor TrhlTiger.Create;
begin
  HashSize := 24;
  BlockSize := 64;
  FPadding := $01;
...
procedure TrhlTiger.Init;
begin
  inherited Init;
  m_hash[0] := $0123456789ABCDEF;
  m_hash[1] := $FEDCBA9876543210;
  m_hash[2] := $F096A5B4C3B2E187;
end;

procedure TrhlTiger.Final(var ADigest);
var
  bits: QWord;
  pad: TBytes;
  padIndex: DWord;
begin
  ...
  if (FBuffer.Pos < 56) then padIndex := (56 - FBuffer.Pos) else padIndex := (120 - FBuffer.Pos);
